...
// Create a tempStack.
// Repeat until the OGstack is not empty
// Pop an element from OGstack call it store it in temp variable.
// While tempStack is not empty and .top of the tempStack < temp, pop data from tempStack and push it to the OGstack
