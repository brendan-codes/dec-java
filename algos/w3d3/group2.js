...
class DLList {
    ...
    exists(value) {
        let frontR = this.head;
        let tailR = this.tail;
        for (var i = 0; i < this.length / 2; i++) {
            if (frontR.data == value || tailR.data == value) {
                return true;
            }
            frontR = frontR.next;
            tailR = tailR.prev;
    ...
    reverse() {
        ...
        for (var i = 0; i < this.length; i++) { // reversing next and prev pointers
        ...
        // reversing head and tail pointers
        let temp2 = this.head;
        this.head = this.tail;
        this.tail = temp2;
    }
